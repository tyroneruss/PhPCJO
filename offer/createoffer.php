                            ...
                            <table border="0" width="600" style="background-color: white">
                                ...
                                <tr>
                                  ...
                                  <td width="70%" height="25" style="font-family: Times New Roman; font-size: 15px" >
                                    <select name="industry" style="width: 300px">
                                ...
                                <tr>
                                   <td width="10%" height="25">
                                    ...
                                    <td width="70%" height="25">
                                        <input type="text" name="positionIitle" value="" size="11" />
                                    </td>
                                </tr>
                                <tr>
                                    <td width="10%" height="25" style="font-family: Times New Roman; font-size: 14px">
                                    </td>
                                    <td width="20%" height="25" style="font-family: Times New Roman; font-size: 15px">
                                       Base Salary<font color="red">*</font>
                                    </td>
                                    <td width="70%" height="25">
                                        <input type="text" name="baseSalary" value="" size="11" />
                                    </td>
                                </tr>
                               <tr>
                                    <td width="10%" height="25" style="font-family: Times New Roman; font-size: 14px">
                                    ...
                                    <td width="20%" height="25" style="font-family: Times New Roman; font-size: 15px">
                                       Hourly<font color="red">*</font>
                                    </td>
                                    <td width="70%" height="25">
                                        <input type="text" name="Wage" value="" size="5" />/hour
                                    </td>
                                </tr>
                                <tr>
                                   <td width="10%" height="25" style="font-family: Times New Roman; font-size: 17px">
